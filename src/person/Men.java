...
public class Men extends Person {
    ...
    public Men(String first_name, String last_name, int age, String hairColor, String eyeColor, int height, int weight, Shoes shoses, TopDress topDress, DownDress downDress, Hat hat, Cat cat, Dog dog) {
